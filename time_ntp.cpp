...
unsigned long getNTPTimestamp()
{
  ...
  Serial.print("ip timeserver : ");Serial.print(String(ntpServerName));Serial.print (String(timeServerIP));Serial.print ( "\n");
...
{
  Serial.println("sending NTP packet...");Serial.print(String(address));
